...
CMS requires one file to calculate the distances among microbiomes:

1. Microbial abundance table (e.g. OTU table). Currently CMS supports OTUs of Greengenes (v13-8),Greengenes2, SILVA, and RefSeq. More reference database will be released soon. For example
...
This input can be generated by **PM-select-taxa** command from the Parallel Meta suite(PMS). URL for PMS is <https://github.com/qdu-bioinfo/parallel-meta-suite/tree/main>
